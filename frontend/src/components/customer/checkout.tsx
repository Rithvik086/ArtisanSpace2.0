...
import CustomerHeader from './CustomerHeader'; // Added import
import CustomerFooter from './CustomerFooter'; // Added import
...
const Checkout: React.FC = () => {
    ...
    if (loading) {
        return (
            <React.Fragment>
                <CustomerHeader />
                <div className="loading-spinner" style={{ display: 'block', minHeight: '60vh' }}>
    ...
    if (!checkoutData) {
        return (
            <React.Fragment>
                <CustomerHeader />
                <div style={{ textAlign: 'center', padding: '20px', color: '#dc3545', minHeight: '60vh' }}>
