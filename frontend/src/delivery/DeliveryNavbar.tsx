      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-20">
          ...
          <nav className="hidden md:flex space-x-4">
            {navItems.map((item) => (
              <Link
                key={item.name}
                to={item.href}
                className="font-semibold text-lg text-amber-900 hover:text-amber-950 transition-colors font-baloo"
              >
                {item.name}
              </Link>
            ))}
          ...
          <div className="hidden md:flex items-center space-x-4">
            <span className="text-amber-900 font-medium font-baloo">
          ...
          <div className="px-2 pt-2 pb-3 space-y-1">
            {navItems.map((item) => (
              <Link
                ...
                className="block px-3 py-2 rounded-md text-base font-medium text-amber-900 hover:text-amber-950 hover:bg-amber-100 font-baloo"
              >
                {item.name}
              </Link>
            ))}
            <div className="border-t pt-2 mt-2">
              <button
                ...
                className="flex items-center w-full px-3 py-2 rounded-md text-base font-medium text-amber-900 hover:text-amber-950 hover:bg-amber-100 font-baloo"
              >
